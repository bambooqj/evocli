...
REGISTRY: list[ToolSpec] = [
    ...
    ToolSpec(
        ...
        tier=3, pydantic=True, base_score=0.8,
    ...
    ToolSpec(
        ...
        tags=[Tag.IMPACT, Tag.VERIFY],
        tier=3, pydantic=True, base_score=0.75,
    ...
    ToolSpec(
        ...
        tags=[Tag.IMPACT],
        tier=3, pydantic=True, base_score=0.7,
    ...
    ToolSpec(
        ...
        tier=3, pydantic=True, base_score=0.72,
    ...
    ToolSpec(
        ...
        tags=[Tag.ASSUME],
        tier=3, pydantic=True, base_score=0.65,
    ...
    ToolSpec(
        ...
        tags=[Tag.ASSUME, Tag.VERIFY],
        tier=3, pydantic=True, base_score=0.68,
    ...
    ToolSpec(
        ...
        tags=[Tag.ANALYZE],
        tier=3, pydantic=True, base_score=0.73,
    ...
    ToolSpec(
        ...
        tags=[Tag.READ, Tag.ANALYZE],
        tier=3, pydantic=True, base_score=0.6,
